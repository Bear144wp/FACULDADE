...
class Bird(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.speed = 0  # Inicia com velocidade zero
        self.gravity_delay = 15  # Adiciona um delay para a gravidade
...
def main_menu(screen):
    ...
    title_surface = font.render('ESPAÇO p/ começar', True, (255, 255, 255))
    screen.blit(BACKGROUND, (0, 0))
    screen.blit(title_surface, (SCREEN_WIDTH / 2 - title_surface.get_width() / 2, SCREEN_HEIGHT / 2 - title_surface.get_height() / 2))
...
def game_over(screen):
    main_menu(screen)  # Redireciona diretamente para o menu principal
